...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
    ...
    //If e else são condicionais, se o cod 2 receber verdade, irá imprimir algo na tela senão (else) imprime outra coisa, do mesmo modo os outros "cods"	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
		cout << "	      |||||                     ____" << endl;
